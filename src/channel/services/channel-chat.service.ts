...
export class ChatService {
  ...
  removeMutedMember(channel_id: string, user_id: number) {
    this.channelService.unmute(parseInt(channel_id), user_id);
    this.channels[channel_id].mutedMembers.delete(user_id);
  }
